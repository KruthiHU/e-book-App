...
import com.example.ecloudapp.adapters.AdapterPdfFavorite;
import com.example.ecloudapp.databinding.ActivityProfileBinding;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void emailVerificationDialog() {
        ...
        builder.setTitle("Verify Email")
                .setMessage("Are you sure you want to send an email verification instructions to your email"+firebaseUser.getEmail())
    ...
    private void loadUserInfo() {
        ...
        //get email verification status,after verification re-login is necessary
        if (firebaseUser.isEmailVerified()){
            //already verified
