...
import static com.example.ecloudapp.Constants.MAX_BYTES_PDF;
...
import com.example.ecloudapp.activities.dashboardUserActivity;
...
// no need to rewrite again
                        ...
                        pdfView.fromBytes(bytes)
                                ...
                                .onLoad(new OnLoadCompleteListener() {
                                    ...
                                    public void loadComplete(int nbPages) {
                                        ...
                                        //if pagesTv param is not null then set page no.s
                                        if (pagesTv!=null){
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl ) {
        ...
        ProgressDialog progressDialog = new ProgressDialog(context);
        progressDialog.setTitle("Please wait");
        progressDialog.setMessage("Downloading" + nameWithExtension + " ...");//e.g:Downloading abc.pdf
    ...
    private static void incrementBookDownloadCount(String bookId) {
        ...
        //S1: Get previous download count
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Books");
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //S2: Update new increment downloads count to db
                        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Books");
                        reference.child(bookId).updateChildren(hashMap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        ref.child(firebaseAuth.getUid()).child("Downloads").child("bookId")
                                                .setValue(hashMap)
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    @Override
                                                    public void onSuccess(Void unused) {
                                                       Toast.makeText(context,"Adding to your download list", Toast.LENGTH_SHORT).show();
                                                    }
                                                })
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    @Override
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(context,"Failed to add to download list due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                    }
                                })
        ...
        if (firebaseAuth.getCurrentUser() == null) {
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child("bookId")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(context, "Adding to your favorite list", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context, "Failed to add to favorite list due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
        ...
        if (firebaseAuth.getCurrentUser() == null) {
            ...
            ref.child(firebaseAuth.getUid()).child("Favorites").child(bookId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(context, "Removing from your favorite list", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
