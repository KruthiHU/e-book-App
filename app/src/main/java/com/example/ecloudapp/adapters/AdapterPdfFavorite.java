...
import com.example.ecloudapp.databinding.RowPdfFavoriteBinding;
...
public class AdapterPdfFavorite extends RecyclerView.Adapter<AdapterPdfFavorite.HolderPdfFavorite> {
    ...
    public final ArrayList<ModelPdf> pdfArrayList;

    // view binding for row_pdf_favorite.xml
    public RowPdfFavoriteBinding binding;
    ...
    public int getItemCount() {
        return pdfArrayList.size();//return list size or no. of records
    }
